      ...
      <div className="page">
        <div className="header">
          <div className="container">
            <p className="title">Privacy Policy for Digital Library</p>
          </div>
        </div>
          ...
          <div className="container">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Digital
                    Library.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Digital Library,
                    accessible from{" "}
                    <a
                      href="https://digital-library-web.vercel.app/"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://digital-library-web.vercel.app/
                    </a>
                  </p>
                </li>
                <li>
              ...
              <p>
                ...
                s Internet Protocol address (e.g. IP address), browser type,
              ...
              <ul>
                <li>By email: cvamsik99@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
